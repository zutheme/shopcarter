...
<button class="topbar-dropdown__btn" type="button">My Account
	<!-- <svg width="7px" height="5px"><use xlink:href="images/sprite.svg#arrow-rounded-down-7x5"></use></svg> -->
</button>
...
<use xlink:href="images/sprite.svg#arrow-rounded-down-7x5">
</use>
</svg> -->
</button>
<div class="topbar-dropdown__body">
...
<img srcset="<?php bloginfo('template_directory');?>/images/languages/language-1.png, <?php bloginfo('template_directory');?>/images/languages/language-1@2x.png 2x" src="<?php bloginfo('template_directory');?>/images/languages/language-1.png" alt="">
</div>
English</a>
</li>
<li class="menu__item">
...
<a class="menu__item-link" href="">
<div class="menu__item-icon">
<img srcset="<?php bloginfo('template_directory');?>/images/languages/language-2.png, <?php bloginfo('template_directory');?>/images/languages/language-2@2x.png 2x" src="<?php bloginfo('template_directory');?>/images/languages/language-2.png" alt="">
</div>
French</a>
</li>
<li class="menu__item">
...
<a class="menu__item-link" href="">
<div class="menu__item-icon">
<img srcset="<?php bloginfo('template_directory');?>/images/languages/language-3.png, <?php bloginfo('template_directory');?>/images/languages/language-3@2x.png 2x" src="<?php bloginfo('template_directory');?>/images/languages/language-3.png" alt="">
</div>
German</a>
</li>
<li class="menu__item">
...
<a class="menu__item-link" href="">
<div class="menu__item-icon">
<img srcset="<?php bloginfo('template_directory');?>/images/languages/language-4.png, <?php bloginfo('template_directory');?>/images/languages/language-4@2x.png 2x" src="<?php bloginfo('template_directory');?>/images/languages/language-4.png" alt="">
</div>
Russian</a>
</li>
<li class="menu__item">
...
<a class="menu__item-link" href="">
<div class="menu__item-icon">
<img srcset="<?php bloginfo('template_directory');?>/images/languages/language-5.png, <?php bloginfo('template_directory');?>/images/languages/language-5@2x.png 2x" src="<?php bloginfo('template_directory');?>/images/languages/language-5.png" alt="">
</div>
Italian</a>
</li>
</ul>
...
Power Tools <!-- <svg class="departments__item-arrow" width="6px" height="9px">
...
<div class="megamenu__body" style="background-image: url('<?php bloginfo('template_directory');?>/images/megamenu/megamenu-1.jpg');">
<div class="row">
<div class="col-3">
...
<li class="departments__item">
<a class="departments__item-link" href="">
Hand Tools <!-- <svg class="departments__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
<!-- .megamenu -->
<div class="megamenu megamenu--departments">
<div class="megamenu__body" style="background-image: url('<?php bloginfo('template_directory');?>/images/megamenu/megamenu-2.jpg');">
<div class="row">
<div class="col-4">
<ul class="megamenu__links megamenu__links--level--0">
<li class="megamenu__item megamenu__item--with-submenu">
...
<li class="departments__item">
<a class="departments__item-link" href="">
Machine Tools <!-- <svg class="departments__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
<!-- .megamenu -->
<div class="megamenu megamenu--departments">
<div class="megamenu__body" style="background-image: url('<?php bloginfo('template_directory');?>/images/megamenu/megamenu-3.jpg');">
<div class="row">
<div class="col-6">
<ul class="megamenu__links megamenu__links--level--0">
<li class="megamenu__item megamenu__item--with-submenu">
...
<li class="departments__item">
<a class="departments__item-link" href="">
Building Supplies <!-- <svg class="departments__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
<li class="departments__item">
<a class="departments__item-link" href="">
Electrical<!--  <svg class="departments__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
<a class="menu__item-link" href="">
Soldering Equipment <!-- <svg class="menu__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
<li class="menu__item">
<!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. --><div class="menu__item-submenu-offset"></div><a class="menu__item-link" href="">UPS</a></li>
</ul>
</div>
<!-- .menu / end -->
</div>
...
<use xlink:href="images/sprite.svg#menu-18x14">
 ...
 Shop By Category<!--  <svg class="departments__button-arrow" width="9px" height="6px">
...
<a class="nav-links__item-link" href="index-1.html">
<div class="nav-links__item-body">
Home<!--  <svg class="nav-links__item-arrow" width="9px" height="6px">
<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6">
</use>
</svg> -->
</div>
...
<a class="menu__item-link" href="index-1.html">
Home 1 Slideshow</a>
</li>
<li class="menu__item">
<!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
...
<div class="nav-links__item-body">
Megamenu<!--  <svg class="nav-links__item-arrow" width="9px" height="6px">
<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6">
</use>
</svg> -->
</div>
...
<div class="nav-links__item-body">
Shop <!-- <svg class="nav-links__item-arrow" width="9px" height="6px">
<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6">
</use>
</svg> -->
</div>
...
Shop Grid <!-- <svg class="menu__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
Product <!-- <svg class="menu__item-arrow" width="6px" height="9px">
<use xlink:href="images/sprite.svg#arrow-rounded-right-6x9">
</use>
</svg> -->
</a>
...
<div class="nav-links__item-body">
Account <!-- <svg class="nav-links__item-arrow" width="9px" height="6px">
<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6">
</use>
</svg> -->
</div>
...
<a class="nav-links__item-link" href="">
<div class="nav-links__item-body">
Pages <!-- <svg class="nav-links__item-arrow" width="9px" height="6px">
<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6">
</use>
</svg> -->
</div>
...
<div class="indicator indicator--trigger--click">
	<a href="#" class="indicator__button"><span class="indicator__area"><i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="indicator__value">3</span></span></a>
			...
			<div class="dropcart__products-list">
				<div class="dropcart__product">
					<div class="product-image dropcart__product-image">
						<a href="product.html" class="product-image__body"><img class="product-image__img" src="<?php //bloginfo('template_directory');?>/images/products/product-1.jpg" alt=""></a>
					</div>
				...
				<div class="dropcart__product">
					<div class="product-image dropcart__product-image">
						<a href="product.html" class="product-image__body"><img class="product-image__img" src="<?php //bloginfo('template_directory');?>/images/products/product-2.jpg" alt=""></a>
					</div>
					<div class="dropcart__product-info">
						<div class="dropcart__product-name">
						...
						<div class="dropcart__product-meta">
							<span class="dropcart__product-quantity">1</span>× <span class="dropcart__product-price">$849.00</span>
						</div>
					</div>
					<button type="button" class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon">
						<svg width="10px" height="10px">
				...
				<div class="dropcart__product">
					<div class="product-image dropcart__product-image">
						<a href="product.html" class="product-image__body"><img class="product-image__img" src="<?php //bloginfo('template_directory');?>/images/products/product-5.jpg" alt=""></a>
					</div>
					<div class="dropcart__product-info">
						...
						<div class="dropcart__product-meta">
							<span class="dropcart__product-quantity">3</span>× <span class="dropcart__product-price">$1,210.00</span>
						</div>
					</div>
					<button type="button" class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon">
						 <svg width="10px" height="10px">
...
<img src="<?php bloginfo('template_directory');?>/images/avatars/avatar-3.jpg" alt="">
</div>
<div class="account-menu__user-info">
<div class="account-menu__user-name">
Helena Garcia</div>
<div class="account-menu__user-email">
stroyka@example.com</div>
</div>
</a>
<div class="account-menu__divider">
</div>
