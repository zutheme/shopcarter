            ...
            <tbody class="cart-table__body">
               <tr class="cart-table__row">
                  <td class="cart-table__column cart-table__column--image">
                     <div class="product-image"><a href="" class="product-image__body"><img class="product-image__img" src="images\products\product-1.jpg" alt=""></a>
                     </div>
                  </td>
                  ...
                  <td class="cart-table__column cart-table__column--remove">
                     ...
                     <use xlink:href="images/sprite.svg#cross-12"></use></svg></button>
                  </td>
               </tr>
               <tr class="cart-table__row">
                  <td class="cart-table__column cart-table__column--image">
                     <div class="product-image"><a href="" class="product-image__body"><img class="product-image__img" src="images\products\product-2.jpg" alt=""></a>
                     </div>
                  </td>
                  <td class="cart-table__column cart-table__column--product">
               ...
               <tr class="cart-table__row">
                  <td class="cart-table__column cart-table__column--image">
                     <div class="product-image">
                        <a href="" class="product-image__body"><img class="product-image__img" src="images\products\product-5.jpg" alt=""></a>
                     </div>
                  </td>
                  <td class="cart-table__column cart-table__column--product">
                  ...
                  <div class="card-body">
                     ...
                     <table class="cart__totals">
                        ...
                        <tbody class="cart__totals-body">
                           <tr>
                              <th>Shipping</th>
                              <td>$25.00<div class="cart__calc-shipping"><a href="#">Calculate Shipping</a></div></td>
                           </tr>
                           <tr>
                              <th>Tax</th>
                              <td>$0.00</td>
